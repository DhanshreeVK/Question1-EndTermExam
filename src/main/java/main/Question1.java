...
public class Question1 {
	public static void main(String[] args){
		...
		case 1:
		{
			...
			ECE dept = new ECE();
			System.out.println(dept.displayCourseDetails("ECE"));//call the function of the class that you initialized
			break;
		}
		case 2:
		{
			...
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			Mechanical dept = new Mechanical();
			System.out.println(dept.displayCourseDetails("Mechnical"));//call the function of the class that you initialized
			break;
		}
		case 3:
		{
			...
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			CSE dept = new CSE();
			System.out.println(dept.displayCourseDetails("CSE"));//call the function of the class that you initialized
			break;
		}
		default:
